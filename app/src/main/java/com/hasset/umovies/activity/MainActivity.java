...
public class MainActivity extends AppCompatActivity {
    ...
    private void fetchAndLoadData() {
        ...
        TmdbApiInterface apiService = RetrofitApiClient.getClient().create(TmdbApiInterface.class);
        ...
        call.enqueue(new Callback<MovieResponse>() {
            ...
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                ...
                GalleryAdapter galleryAdapter = new GalleryAdapter(movies, R.layout.gallery_thumbnail, getApplicationContext());
